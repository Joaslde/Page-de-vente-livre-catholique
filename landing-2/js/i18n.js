const resources = {
    fr: {
      translation: {
        ...
        "pain_title": "Ce qui détruit votre",
        "pain_him_title": "Pour lui",
        "pain_him_text": "La peur de ne pas durer assez longtemps, le stress de la performance ou l'impression de ne pas savoir comment s'y prendre techniquement.",
        "pain_her_title": "Pour elle",
        "pain_her_text": "La routine qui s'installe, la difficulté à exprimer ses désirs ou l'envie de découvrir de nouvelles sensations sans tabou.",
        ...
        "men_section_title": "Section Hommes : La Maîtrise Totale",
        ...
        "women_section_title": "Section Femmes : L'Explosion des Sens",
        ...
        "why_2": "Des techniques testées et approuvées.",
        "why_3": "Une approche professionnelle et décomplexée.",
        ...
        "cta_button": "IL ME FAUT CE MANUEL"
      }
    },
    es: {
      translation: {
        ...
        "why_2": "Técnicas probadas y aprobadas.",
        "why_3": "Un enfoque profesional y desacomplejado.",
        ...
        "cta_button": "NECESITO ESTE MANUAL"
      }
    }
  };
  ...
  i18next.init({
    lng: navigator.language.startsWith('es') ? 'es' : 'fr', // Détection auto avec fallback
    fallbackLng: 'fr',
    resources: resources
  }, function(err, t) {
    updateContent();
